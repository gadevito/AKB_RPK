...
contract EnergyTrading {
    ...
    function placeBuyOrder(address _seller, uint256 _energyQuantity, uint256 _price) public {
        uint256 totalPrice = _energyQuantity * _price;
        require(buyerBalances[msg.sender] >= totalPrice, "Insufficient funds deposited");
    ...
    function executeTransaction(uint256 transactionId) public onlyParticipant(transactionId) {
        ...
        require(buyerBalances[transaction.buyer] >= totalPrice, "Insufficient buyer balance");

        transaction.executed = true;
        buyerBalances[transaction.buyer] -= totalPrice;
