...
contract EnergyTrading {
    ...
    modifier onlyParticipant(uint256 transactionId) {
        require(
            ...
            "Not a participant in this transaction"
        );
        _;
    }
    ...
    function placeBuyOrder(address _seller, uint256 _energyQuantity, uint256 _price) public payable {
        require(msg.value == _energyQuantity * _price, "Incorrect Ether value sent");
    ...
    function executeTransaction(uint256 transactionId) public onlyParticipant(transactionId) {
        ...
        emit TransactionExecuted(transactionId, transaction.buyer, transaction.seller, transaction.energyQuantity, totalPrice);
    }
