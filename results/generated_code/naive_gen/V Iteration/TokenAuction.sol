...
contract TokenAuction is ERC1155, Pausable, Ownable {
    ...
    event PlatformSharePercentageUpdated(uint256 newPercentage);
    ...
    constructor(address _owner, address _usdcTokenAddress) Ownable() ERC1155("") {
    ...
    function mintBatch(string[] memory _metadataCIDs) external onlyOwner whenNotPaused {
        require(_metadataCIDs.length <= batchSize, "Batch size exceeds maximum");
