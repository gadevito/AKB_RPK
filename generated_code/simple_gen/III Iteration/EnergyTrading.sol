...
contract EnergyTrading is ReentrancyGuard {
    ...
    modifier onlyParticipant(address _buyer, address _seller) {
        require(msg.sender == _buyer || msg.sender == _seller, "Not a participant");
        _;
    }
    ...
    function placeBuyOrder(address _seller, uint256 _energyQuantity, uint256 _price) public {
        ...
        require(_energyQuantity > 0, "Energy quantity must be greater than zero");
    ...
    function executeTransaction(uint256 _transactionId) public onlyParticipant(transactions[_transactionId].buyer, transactions[_transactionId].seller) {
