...
contract SubscriptionService {
    ...
    function subscribe() external payable {
        ...
        require(subscriptionExpiry[msg.sender] < block.timestamp, "Subscription is still active");
    ...
    function renewSubscription() external payable {
        require(msg.value == subscriptionFee, "Incorrect subscription fee");
        require(subscriptionExpiry[msg.sender] >= block.timestamp, "Subscription has expired, please subscribe first");
