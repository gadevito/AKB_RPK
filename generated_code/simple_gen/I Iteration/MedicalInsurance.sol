...
contract MedicalInsurance {
    ...
    event PolicyCreated(uint256 id, address policyholder, uint256 premium, uint256 coverageAmount, bool active);
    ...
    function createPolicy(address policyholder, uint256 premium, uint256 coverageAmount) external onlyOwner {
        ...
        emit PolicyCreated(nextPolicyId, policyholder, premium, coverageAmount, false);
        nextPolicyId++;
    }
