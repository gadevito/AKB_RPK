...
contract RentalAgreement {
    ...
    function getRentPaymentsCount() public view returns (uint256) {
        return rentPayments.length;
    }

    function getRentPayment(uint256 index) public view returns (uint256 amount, uint256 timestamp) {
        require(index < rentPayments.length, "Index out of bounds");
        RentPayment storage payment = rentPayments[index];
